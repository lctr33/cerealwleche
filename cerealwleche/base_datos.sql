...
CREATE TABLE `Precios` (
  `idNombreServicio` varchar(255) NOT NULL,
  `precio1Mes` int DEFAULT NULL,
  `precio2Meses` int DEFAULT NULL,
  `precio3Meses` int DEFAULT NULL,
  `precio6Meses` int DEFAULT NULL,
  `precio1Anio` int DEFAULT NULL,
...
INSERT INTO `Precios` VALUES ('crunchyroll',120,230,330,640,1200),('disney_premium',250,480,700,1350,2500),('disney_standar',180,350,510,1000,1800),('max',150,290,420,800,1500),('netflix',220,430,630,1250,2400),('paramount',110,210,300,580,1100),('prime_video',100,190,270,520,1000);
...
CREATE TABLE `Compras_pendientes` (
  ...
  `informacion_de_la_compra` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2025-07-03 17:31:55
